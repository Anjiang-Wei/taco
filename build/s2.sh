...
#  -dm:replicate 0
# -level mapper=debug -logfile mapper_taco%.log -lg:prof 2 -lg:prof_logfile prof_%.gz
# -level mapper=debug -logfile mapper_dsl%.log -lg:prof 2 -lg:prof_logfile prof_dsl%.gz
...
# mpirun --bind-to none ./bin/cannonMM-cuda -n 8192 -ll:gpu 4 -ll:fsize 15G -ll:ocpu 1 -ll:othr 1 -ll:nsize 30G -ll:ncsize 0 -gx 1 -gy 2 -mapping mappings 
mpirun --bind-to none ./bin/cannonMM-cuda -n 8192 -ll:gpu 4 -ll:fsize 15G -ll:ocpu 1 -ll:othr 1 -ll:nsize 30G -ll:ncsize 0 -gx 1 -gy 2 -mapping mappings -level mapper=debug -logfile mapper_dsl%.log -lg:prof 2 -lg:prof_logfile prof_dsl%.gz
