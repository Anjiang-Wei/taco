...
mpirun --bind-to none ./bin/cannonMM-cuda -n 8192 -lg:partcheck -lg:safe_mapper -ll:gpu 4 -ll:fsize 15G -ll:ocpu 1 -ll:othr 1 -ll:nsize 30G -ll:ncsize 0 -gx 1 -gy 2 -mapping mappings -level mapper=debug -logfile slurm_my_incorrect%.log
