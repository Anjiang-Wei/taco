...
mpirun --bind-to none ../bin/cannonMM-cuda -n 20000 -ll:gpu 4 -ll:fsize 15G -ll:ocpu 1 -ll:othr 1 -ll:nsize 30G -ll:ncsize 0 -gx 1 -gy 2 -level mapper=debug -logfile mapper24_taco%.log -wrapper -dm:exact_region -tm:untrack_valid_regions
