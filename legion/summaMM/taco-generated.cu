...
extern "C" void task_5(const Task* task, const std::vector<PhysicalRegion>& regions, Context ctx, Runtime* runtime) {
  ...
  for (PointInDomainIterator<1> itr = PointInDomainIterator<1>(domain); itr.valid(); itr++) {
    int64_t kio = (*itr)[0];
    Point<2> bStart = Point<2>((in * ((b1_dimension + (gridX - 1)) / gridX) + iln * (((b1_dimension + (gridX - 1)) / gridX + 1) / 2)), (ko * ((b2_dimension + (gridX - 1)) / gridX) + kio * (((b2_dimension + (gridX - 1)) / gridX + 1) / 2)));
    Point<2> bEnd = Point<2>(TACO_MIN((in * ((b1_dimension + (gridX - 1)) / gridX) + (iln * (((b1_dimension + (gridX - 1)) / gridX + 1) / 2) + (((b1_dimension + (gridX - 1)) / gridX + 1) / 2 - 1))),bDomain.hi()[0]), TACO_MIN((ko * ((b2_dimension + (gridX - 1)) / gridX) + (kio * (((b2_dimension + (gridX - 1)) / gridX + 1) / 2) + (((b2_dimension + (gridX - 1)) / gridX + 1) / 2 - 1))),bDomain.hi()[1]));
    Rect<2> bRect = Rect<2>(bStart, bEnd);
    if (!bDomain.contains(bRect.lo) || !bDomain.contains(bRect.hi)) {
      bRect = bRect.make_empty();
    }
    bColoring[(*itr)] = bRect;
    Point<2> cStart = Point<2>((ko * ((b2_dimension + (gridX - 1)) / gridX) + kio * (((b2_dimension + (gridX - 1)) / gridX + 1) / 2)), (jn * ((c2_dimension + (gridY - 1)) / gridY) + jln * (((c2_dimension + (gridY - 1)) / gridY + 1) / 2)));
    Point<2> cEnd = Point<2>(TACO_MIN((ko * ((b2_dimension + (gridX - 1)) / gridX) + (kio * (((b2_dimension + (gridX - 1)) / gridX + 1) / 2) + (((b2_dimension + (gridX - 1)) / gridX + 1) / 2 - 1))),cDomain.hi()[0]), TACO_MIN((jn * ((c2_dimension + (gridY - 1)) / gridY) + (jln * (((c2_dimension + (gridY - 1)) / gridY + 1) / 2) + (((c2_dimension + (gridY - 1)) / gridY + 1) / 2 - 1))),cDomain.hi()[1]));
    Rect<2> cRect = Rect<2>(cStart, cEnd);
    if (!cDomain.contains(cRect.lo) || !cDomain.contains(cRect.hi)) {
      cRect = cRect.make_empty();
    }
...
extern "C" void task_6(const Task* task, const std::vector<PhysicalRegion>& regions, Context ctx, Runtime* runtime) {
  ...
  for (PointInDomainIterator<2> itr = PointInDomainIterator<2>(domain); itr.valid(); itr++) {
    ...
    bColoring[(*itr)] = bRect;
    Point<2> cStart = Point<2>((ko * ((b2_dimension + (gridX - 1)) / gridX)), (jn * ((c2_dimension + (gridY - 1)) / gridY) + jln * (((c2_dimension + (gridY - 1)) / gridY + 1) / 2)));
    Point<2> cEnd = Point<2>(TACO_MIN((ko * ((b2_dimension + (gridX - 1)) / gridX) + ((b2_dimension + (gridX - 1)) / gridX - 1)),cDomain.hi()[0]), TACO_MIN((jn * ((c2_dimension + (gridY - 1)) / gridY) + (jln * (((c2_dimension + (gridY - 1)) / gridY + 1) / 2) + (((c2_dimension + (gridY - 1)) / gridY + 1) / 2 - 1))),cDomain.hi()[1]));
    Rect<2> cRect = Rect<2>(cStart, cEnd);
    if (!cDomain.contains(cRect.lo) || !cDomain.contains(cRect.hi)) {
      cRect = cRect.make_empty();
    }
