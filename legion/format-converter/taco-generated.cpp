...
void packLegionCOOToCSR(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* T, LegionTensor* TCOO) {
  ...
  auto T_vals_field_id = T->valsFieldID;
  auto T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
  auto T2_indices_field_id_1_0 = T->indicesFieldIDs[1][0];
  ...
  auto TCOO_vals_field_id = TCOO->valsFieldID;
  auto TCOO_vals_ro_accessor = createAccessor<AccessorROdouble1>(TCOO_vals, TCOO_vals_field_id);
  auto TCOO1_indices_field_id_0_0 = TCOO->indicesFieldIDs[0][0];
  auto TCOO1_indices_field_id_0_1 = TCOO->indicesFieldIDs[0][1];
  auto TCOO2_indices_field_id_1_0 = TCOO->indicesFieldIDs[1][0];
  auto TCOO1_pos_accessor = createAccessor<AccessorRORect_1_1>(TCOO1_pos, TCOO1_indices_field_id_0_0);
  auto TCOO1_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO1_crd, TCOO1_indices_field_id_0_1);
  auto TCOO2_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO2_crd, TCOO2_indices_field_id_1_0);
  RegionWrapper T2_nnz_vals;
  auto T2_nnz_vals_rw_accessor = createAccessor<AccessorRWint64_t1>(T2_nnz_vals, FID_VAL);

  TCOO1_pos = legionMalloc(ctx, runtime, TCOO1_pos, TCOO1_pos_parent, TCOO1_indices_field_id_0_0, READ_ONLY);
  TCOO1_pos_accessor = createAccessor<AccessorRORect_1_1>(TCOO1_pos, TCOO1_indices_field_id_0_0);
  TCOO1_crd = legionMalloc(ctx, runtime, TCOO1_crd, TCOO1_crd_parent, TCOO1_indices_field_id_0_1, READ_ONLY);
  TCOO1_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO1_crd, TCOO1_indices_field_id_0_1);
  TCOO2_crd = legionMalloc(ctx, runtime, TCOO2_crd, TCOO2_crd_parent, TCOO2_indices_field_id_1_0, READ_ONLY);
  TCOO2_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO2_crd, TCOO2_indices_field_id_1_0);
  TCOO_vals = legionMalloc(ctx, runtime, TCOO_vals, TCOO_vals_parent, TCOO_vals_field_id, READ_ONLY);
  TCOO_vals_ro_accessor = createAccessor<AccessorROdouble1>(TCOO_vals, TCOO_vals_field_id);
  ...
  T2_pos = legionMalloc(ctx, runtime, T2_pos, T2_pos_parent, T2_indices_field_id_1_0, READ_WRITE);
  T2_pos_accessor = createAccessor<AccessorRWRect_1_1>(T2_pos, T2_indices_field_id_1_0);
  T2_crd = legionMalloc(ctx, runtime, T2_crd, T2_crd_parent, T2_indices_field_id_1_1, READ_WRITE);
  T2_crd_accessor = createAccessor<AccessorRWint32_t1>(T2_crd, T2_indices_field_id_1_1);
  T_vals = legionMalloc(ctx, runtime, T_vals, T_vals_parent, T_vals_field_id, READ_WRITE);
  T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
  ...
  RectCompressedFinalizeYieldPositions::compute(ctx, runtime, T2_pos, T2_seq_insert_edges_result.partition, T2_indices_field_id_1_0);
...
void packLegionCOOToSSS(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* T, LegionTensor* TCOO) {
  ...
  auto T_vals_field_id = T->valsFieldID;
  auto T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
  auto T1_indices_field_id_0_0 = T->indicesFieldIDs[0][0];
  auto T1_indices_field_id_0_1 = T->indicesFieldIDs[0][1];
  auto T2_indices_field_id_1_0 = T->indicesFieldIDs[1][0];
  auto T2_indices_field_id_1_1 = T->indicesFieldIDs[1][1];
  auto T3_indices_field_id_2_0 = T->indicesFieldIDs[2][0];
  auto T3_indices_field_id_2_1 = T->indicesFieldIDs[2][1];
  auto T1_pos_accessor = createAccessor<AccessorRWRect_1_1>(T1_pos, T1_indices_field_id_0_0);
  auto T1_crd_accessor = createAccessor<AccessorRWint32_t1>(T1_crd, T1_indices_field_id_0_1);
  auto T2_pos_accessor = createAccessor<AccessorRWRect_1_1>(T2_pos, T2_indices_field_id_1_0);
  auto T2_crd_accessor = createAccessor<AccessorRWint32_t1>(T2_crd, T2_indices_field_id_1_1);
  auto T3_pos_accessor = createAccessor<AccessorRWRect_1_1>(T3_pos, T3_indices_field_id_2_0);
  ...
  auto TCOO1_indices_field_id_0_1 = TCOO->indicesFieldIDs[0][1];
  auto TCOO2_indices_field_id_1_0 = TCOO->indicesFieldIDs[1][0];
  auto TCOO3_indices_field_id_2_0 = TCOO->indicesFieldIDs[2][0];
  auto TCOO1_pos_accessor = createAccessor<AccessorRORect_1_1>(TCOO1_pos, TCOO1_indices_field_id_0_0);
  auto TCOO1_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO1_crd, TCOO1_indices_field_id_0_1);
  auto TCOO2_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO2_crd, TCOO2_indices_field_id_1_0);
  auto TCOO3_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO3_crd, TCOO3_indices_field_id_2_0);
  ...
  TCOO2_crd = legionMalloc(ctx, runtime, TCOO2_crd, TCOO2_crd_parent, TCOO2_indices_field_id_1_0, READ_ONLY);
  TCOO2_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO2_crd, TCOO2_indices_field_id_1_0);
  TCOO3_crd = legionMalloc(ctx, runtime, TCOO3_crd, TCOO3_crd_parent, TCOO3_indices_field_id_2_0, READ_ONLY);
  TCOO3_crd_accessor = createAccessor<AccessorROint32_t1>(TCOO3_crd, TCOO3_indices_field_id_2_0);
  TCOO_vals = legionMalloc(ctx, runtime, TCOO_vals, TCOO_vals_parent, TCOO_vals_field_id, READ_ONLY);
  TCOO_vals_ro_accessor = createAccessor<AccessorROdouble1>(TCOO_vals, TCOO_vals_field_id);



  T1_pos = legionMalloc(ctx, runtime, T1_pos_parent, 1, T1_indices_field_id_0_0, READ_WRITE);
  T1_pos_accessor = createAccessor<AccessorRWRect_1_1>(T1_pos, T1_indices_field_id_0_0);
  T1_pos_accessor[Point<1>(0)] = Rect<1>(0, -1);
  int64_t T1_crd_size = 1;
  T1_crd = legionMalloc(ctx, runtime, T1_crd_parent, T1_crd_size, T1_indices_field_id_0_1, READ_WRITE);
  T1_crd_accessor = createAccessor<AccessorRWint32_t1>(T1_crd, T1_indices_field_id_0_1);
  int64_t iT = 0;
  int64_t T2_pos_size = 1;
  T2_pos = legionMalloc(ctx, runtime, T2_pos_parent, T2_pos_size, T2_indices_field_id_1_0, READ_WRITE);
  T2_pos_accessor = createAccessor<AccessorRWRect_1_1>(T2_pos, T2_indices_field_id_1_0);
  T2_pos_accessor[Point<1>(0)] = Rect<1>(0, -1);
  int64_t T2_crd_size = 1;
  T2_crd = legionMalloc(ctx, runtime, T2_crd_parent, T2_crd_size, T2_indices_field_id_1_1, READ_WRITE);
  T2_crd_accessor = createAccessor<AccessorRWint32_t1>(T2_crd, T2_indices_field_id_1_1);
  int64_t jT = 0;
  int64_t T3_pos_size = 1;
  T3_pos = legionMalloc(ctx, runtime, T3_pos_parent, T3_pos_size, T3_indices_field_id_2_0, READ_WRITE);
  T3_pos_accessor = createAccessor<AccessorRWRect_1_1>(T3_pos, T3_indices_field_id_2_0);
  T3_pos_accessor[Point<1>(0)] = Rect<1>(0, -1);
  int64_t T3_crd_size = 1;
  T3_crd = legionMalloc(ctx, runtime, T3_crd_parent, T3_crd_size, T3_indices_field_id_2_1, READ_WRITE);
  T3_crd_accessor = createAccessor<AccessorRWint32_t1>(T3_crd, T3_indices_field_id_2_1);
  int64_t kT = 0;
  int64_t T_capacity = 1;
  T_vals = legionMalloc(ctx, runtime, T_vals_parent, T_capacity, T_vals_field_id, READ_WRITE);
  T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
  ...
  while (iTCOO < pTCOO1_end) {
    ...
    if (T2_pos_size <= iT) {
      T2_pos = legionRealloc(ctx, runtime, T2_pos_parent, T2_pos, T2_pos_size * 2, T2_indices_field_id_1_0, READ_WRITE);
      T2_pos_accessor = createAccessor<AccessorRWRect_1_1>(T2_pos, T2_indices_field_id_1_0);
    ...
    while (jTCOO < pTCOO2_end) {
      ...
      if (T3_pos_size <= jT) {
        T3_pos = legionRealloc(ctx, runtime, T3_pos_parent, T3_pos, T3_pos_size * 2, T3_indices_field_id_2_0, READ_WRITE);
        T3_pos_accessor = createAccessor<AccessorRWRect_1_1>(T3_pos, T3_indices_field_id_2_0);
      ...
      for (int64_t kTCOO = jTCOO; kTCOO < ((TCOO2_segend - 1) + 1); kTCOO++) {
        ...
        if (T_capacity <= kT) {
          T_vals = legionRealloc(ctx, runtime, T_vals_parent, T_vals, T_capacity * 2, T_vals_field_id, READ_WRITE);
          T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
          T_capacity = T_capacity * 2;
        }
        T_vals_rw_accessor[Point<1>(kT)] = TCOO_vals_ro_accessor[Point<1>(kTCOO)];
        if (T3_crd_size <= kT) {
          T3_crd = legionRealloc(ctx, runtime, T3_crd_parent, T3_crd, T3_crd_size * 2, T3_indices_field_id_2_1, READ_WRITE);
          T3_crd_accessor = createAccessor<AccessorRWint32_t1>(T3_crd, T3_indices_field_id_2_1);
      ...
      if (pT3_begin < kT) {
        if (T2_crd_size <= jT) {
          T2_crd = legionRealloc(ctx, runtime, T2_crd_parent, T2_crd, T2_crd_size * 2, T2_indices_field_id_1_1, READ_WRITE);
          T2_crd_accessor = createAccessor<AccessorRWint32_t1>(T2_crd, T2_indices_field_id_1_1);
    ...
    if (pT2_begin < jT) {
      if (T1_crd_size <= iT) {
        T1_crd = legionRealloc(ctx, runtime, T1_crd_parent, T1_crd, T1_crd_size * 2, T1_indices_field_id_0_1, READ_WRITE);
        T1_crd_accessor = createAccessor<AccessorRWint32_t1>(T1_crd, T1_indices_field_id_0_1);
...
void packLegionCOOToDDS(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* T, LegionTensor* TCOO) {
  ...
  T3_pos = legionMalloc(ctx, runtime, T3_pos, T3_pos_parent, T3_indices_field_id_2_0, READ_WRITE);
  T3_pos_accessor = createAccessor<AccessorRWRect_1_2>(T3_pos, T3_indices_field_id_2_0);
  T3_crd = legionMalloc(ctx, runtime, T3_crd, T3_crd_parent, T3_indices_field_id_2_1, READ_WRITE);
  T3_crd_accessor = createAccessor<AccessorRWint32_t1>(T3_crd, T3_indices_field_id_2_1);
  T_vals = legionMalloc(ctx, runtime, T_vals, T_vals_parent, T_vals_field_id, READ_WRITE);
  T_vals_rw_accessor = createAccessor<AccessorRWdouble1>(T_vals, T_vals_field_id);
  ...
  RectCompressedFinalizeYieldPositions::compute(ctx, runtime, T3_pos, T3_seq_insert_edges_result.partition, T3_indices_field_id_2_0);
...
void packLegionCOOToSDS(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* T, LegionTensor* TCOO) {
  ...
  runtime->unmap_region(ctx, T3_pos);
  T3_pos = legionMalloc(ctx, runtime, T3_pos_parent, iT, T3_indices_field_id_2_0, READ_WRITE);
  T3_pos_accessor = createAccessor<AccessorRWRect_1_2>(T3_pos, T3_indices_field_id_2_0);
  int64_t csT3 = 0;
...
void packLegionCOOToSD(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* T, LegionTensor* TCOO) {
  ...
  auto T_vals_parent = T->valsParent;
  auto T_vals_field_id = T->valsFieldID;
  auto T_vals_rw_accessor = createAccessor<AccessorRWdouble2>(T_vals, T_vals_field_id);
  auto T1_indices_field_id_0_0 = T->indicesFieldIDs[0][0];
  auto T1_indices_field_id_0_1 = T->indicesFieldIDs[0][1];
  auto T1_pos_accessor = createAccessor<AccessorRWRect_1_1>(T1_pos, T1_indices_field_id_0_0);
  auto T1_crd_accessor = createAccessor<AccessorRWint32_t1>(T1_crd, T1_indices_field_id_0_1);
  ...
  int64_t T_capacity = 1;
  T_vals = legionMalloc(ctx, runtime, T_vals_parent, T_capacity, T_vals_field_id, READ_WRITE);
  T_vals_rw_accessor = createAccessor<AccessorRWdouble2>(T_vals, T_vals_field_id);
  ...
  while (iTCOO < pTCOO1_end) {
    ...
    if (T_capacity <= iT) {
      ...
      T_vals = legionRealloc(ctx, runtime, T_vals_parent, T_vals, T_vals_new_size, T_vals_field_id, READ_WRITE);
      T_vals_rw_accessor = createAccessor<AccessorRWdouble2>(T_vals, T_vals_field_id);
