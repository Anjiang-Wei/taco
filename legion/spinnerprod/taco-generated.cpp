...
partitionPackForcomputeLegion partitionForcomputeLegion(Legion::Context ctx, Legion::Runtime* runtime, LegionTensor* B, LegionTensor* C, int32_t pieces) {
  ...
  LogicalPartition crdPartB3 = runtime->get_logical_partition(ctx, B3_crd, runtime->create_partition_by_image_range(ctx, B3_crd.get_index_space(), posPartB3, B3_pos_parent, FID_RECT_1, runtime->get_index_partition_color_space_name(ctx, posPartB3.get_index_partition())));
  ...
  LogicalPartition crdPartC3 = runtime->get_logical_partition(ctx, C3_crd, runtime->create_partition_by_image_range(ctx, C3_crd.get_index_space(), posPartC3, C3_pos_parent, FID_RECT_1, runtime->get_index_partition_color_space_name(ctx, posPartC3.get_index_partition())));
