...
# Arguments specialized to Sapling.
...
def lgGPUArgs(gpus):
    # -ll:gpu 4 -ll:fsize 15G -ll:ocpu 1 -ll:othr 1 -ll:nsize 30G -ll:ncsize 0
    return [
      '-ll:ocpu', '1',
      '-ll:othr', '1',
      '-ll:gpu', '4',
...
def main():
    ...
    parser.add_argument("--procs", type=int, nargs='+', help="List of node counts to run on", default=[4])
