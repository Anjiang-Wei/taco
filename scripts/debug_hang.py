...
# cd legion/legion;
# The current commit for taco experiment on Lassen: c9db93715e8f0c17983f97e6fd0da7a2fb199ceb
...
'''
# python3 scripts/debug_hang.py --openmp --sockets 2 --cuda --dim 3 --multi-node --threads 20 --no-tblis
# git checkout build
...
with pushd(args.deps_install_dir):
    ...
    with pushd("legion-build"):
        ...
        cmakeDefs = {
            ...
            "CMAKE_CXX_FLAGS": "--std=c++11 -DLEGION_SEPARATE_META_TASKS",
        ...
        if args.cuda:
            ...
            cmakeDefs["Legion_CUDA_ARCH"] = "70" # for lassen
